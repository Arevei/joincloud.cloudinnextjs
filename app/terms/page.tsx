...
const JoinCloudIcon = ({ size = 24 }: { size?: number }) => (
  <svg width={size} height={size} viewBox="0 0 613.36 613.36" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="space-y-8 text-muted-foreground">
            ...
            <section>
              ...
              <div className="mt-4 p-4 rounded-md bg-card border border-border">
                ...
                <p>Email: <EmailLink to="info@joincloud.in" subject="Terms of Service Inquiry">info@joincloud.in</EmailLink></p>
              </div>
            </section>
          </div>
        </div>
